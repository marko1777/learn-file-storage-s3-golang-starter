...
func (cfg *apiConfig) handlerVideoMetaCreate(
...
func (cfg *apiConfig) handlerVideoMetaDelete(
	w http.ResponseWriter,
	r *http.Request,
) {
...
func (cfg *apiConfig) handlerVideosRetrieve(
	w http.ResponseWriter,
	r *http.Request,
) {
	token, err := auth.GetBearerToken(r.Header)
